...
namespace ExpenseTracker.Core.Services
{
    public class TransactionService
    {
        ...
        public async Task<IEnumerable<Transaction>> GetMonthlyReportAsync(int month, int year)
        {
            return await _transactionRepository.GetMonthlyReportAsync(month, year);
        }
    }
}
